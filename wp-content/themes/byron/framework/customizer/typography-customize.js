...
var objFont = {
	...
	featured_subtitle: "#featured-title .sub-title",
	...
	theme_button: 'button, input[type="button"], input[type="reset"], input[type="submit"]',
	theme_pagination: ".byron-pagination, .woocommerce-pagination",
	sidebar_widget_title: "#sidebar .widget .widget-title",
	footer_widget_title: "#footer .widget .widget-title",
	bottom_nav: "#bottom .bottom-bar-copyright a",
	entry_h1: "h1",
	entry_h2: "h2",
	entry_h3: "h3",
	entry_h4: "h4",
	    ...
	    e.bind(function(e) {
	        if (e) {
	            var t = (e.trim().toLowerCase().replace(" ", "-"), "customizer-typography-" + k + "-font-family"),
	                i = e.replace(" ", "%20");
	            i = i.replace(",", "%2C"), i = byron.googleFontsUrl + "/css?family=" + e + ":300italic,400italic,600italic,700italic,800italic,400,300,600,700,800", $("#" + t).length ? $("#" + t).attr("href", i) : $("head").append('<link id="' + t + '" rel="stylesheet" type="text/css" href="' + i + '">')
	        }

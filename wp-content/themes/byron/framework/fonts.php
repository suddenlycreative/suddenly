...
function byron_enqueue_google_font( $font ) {
	...
	// Subset
	$subset = byron_get_mod( 'google_font_subsets', 'latin' );
	...
	// Enqueue style
	wp_enqueue_style( 'byron-google-font-'. $handle, $url, false, false, 'all' );
}
<?php
    ...
    $author_info = get_the_author_meta( 'technix_write_by');
    $facebook_url = get_the_author_meta( 'technix_facebook' );
    $twitter_url = get_the_author_meta( 'technix_twitter' );
    $linkedin_url = get_the_author_meta( 'technix_linkedin' );
    $instagram_url = get_the_author_meta( 'technix_instagram' );
    $technix_url = get_the_author_meta( 'technix_youtube' );
    $technix_write_by = get_the_author_meta( 'technix_write_by' );

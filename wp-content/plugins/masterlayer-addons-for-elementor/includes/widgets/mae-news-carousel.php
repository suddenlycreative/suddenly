    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default' => 'flex-end',
                'selectors' => [
                    '{{WRAPPER}} .master-news .content-wrap' => 'justify-content: {{VALUE}};',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .master-news:hover' => 'transform: translateY( {{SIZE}}{{UNIT}} );',
                ],
                50
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .master-news:hover .sep' => 'background-color: {{VALUE}};',
                ],
                'condition' => [ 'sep!' => '' ]
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .master-news .sep' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        <div class="master-carousel-box" <?php echo $data; ?>>
            ...
            if ( $query->have_posts() ) : ?>
                <?php while ( $query->have_posts() ) : $query->the_post(); 
                    ...
                    // Post date
                    $post_date = sprintf('<span class="post-date">%1$s. <span> %2$s</span></span>', 
                        get_the_date(), 
                        get_post_time( 'g:i A' ));

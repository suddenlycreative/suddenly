!function($, $ele, $i) {
    window.liteTranslated = function (e, t) {
        return elementorCommon.translate(e, null, t, tpcoreEditor.i18n)
    };
    ...
    $app.Views.EmptyTemplateCollection = Marionette.ItemView.extend({
        ...
        template: "#tpcore-liteTemplateLibrary_empty",
        ui: {
    ...
    $app.Views.Loading = Marionette.ItemView.extend({
        template: "#tpcore-liteTemplateLibrary_loading",
        id: "liteTemplateLibrary_loading"
    }), 
    $app.Views.Logo = Marionette.ItemView.extend({
        template: "#tpcore-harry-template-library-header-logo",
        className: "harry-template-library-header-logo",
    ...
    $app.Views.BackButton = Marionette.ItemView.extend({
        template: "#tpcore-liteTemplateLibrary_header-back",
    ...
    $app.Views.Menu = Marionette.ItemView.extend({
        template: "#tpcore-liteTemplateLibrary_header-menu",
    ...
    $app.Views.ResponsiveMenu = Marionette.ItemView.extend({
        template: "#tpcore-liteTemplateLibrary_header-menu-responsive",
    ...
    $app.Views.Actions = Marionette.ItemView.extend({
        template: "#tpcore-liteTemplateLibrary_header-actions",
    ...
    $app.Views.InsertWrapper = Marionette.ItemView.extend({
        template: "#tpcore-liteTemplateLibrary_header-insert",
    ...
    $app.Views.Preview = Marionette.ItemView.extend({
        template: "#tpcore-liteTemplateLibrary_preview",
    ...
    $app.Views.TemplateCollection = Marionette.CompositeView.extend({
        template: "#tpcore-liteTemplateLibrary_templates",
        ...
        setMasonrySkin: function() {
            ...
            if ('block' === $i.library.getFilter("type")) {
        ...
        setTemplatesFoundText: function() {
            ...
            text = "<strong>" + t + "</strong>", text += "block" === e ? " block" : " " + e, t > 1 && (text += "s"), text += " found", this.ui.counter.html(text)
        },
    ...
    $app.Views.Template = Marionette.ItemView.extend({
        template: "#tpcore-liteTemplateLibrary_template",
    ...
    $app.Modal = elementorModules.common.views.modal.Layout.extend({
        ...
        getTemplateActionButton: function(e) {
            var t = e.isPro && !tpcoreEditor.hasPro ? "pro-button" : "insert-button";
            return viewId = "#tpcore-liteTemplateLibrary_" + t, template = Marionette.TemplateCache.get(viewId), Marionette.Renderer.render(template)
        },
        showLogo: function(e) {
    ...
    $app.Manager = function() {
        ...
        function addButton() {
            ...
            }), $sl.find(".tp_templates_add_button").length || $sl.find(DROIT_FIND_SELECTOR).before($tpcorePpenLibraryButton)
        }

        function initAddButton($el) {
            var $t = $el.find(DROIT_FIND_SELECTOR);
            $t.length && !$el.find(".tp_templates_add_button").length && $t.before($tpcorePpenLibraryButton), $el.on("click.onAddElement", ".elementor-editor-section-settings .elementor-editor-element-add", addButton)
        }

        function onChanges(t, i) {
            i.addClass("elementor-active").siblings().removeClass("elementor-active");
            var a = $tpResponsiveMap[t] || $tpResponsiveMap.desktop;
        ...
        function onEditorLoaded() {
            var $el = window.elementor.$previewContents,
                ...
                $el.on("click.onAddTemplateButton", ".tp_templates_add_button", $this.showModal.bind($this)), this.channels.tabs.on("change:device", onChanges)
        }
        ...
        DROIT_FIND_SELECTOR = ".elementor-add-new-section .elementor-add-section-drag-title", 
        $tpcorePpenLibraryButton = '<div class="elementor-add-section-area-button tp_templates_add_button"> <img src="'+tpcoreEditor.templateLogo+'" /> </div>', 
        $tpResponsiveMap = {
            desktop: "100%",
            tab: "768px",
            mobile: "360px"
        ...
        this.init = function() {
            $this.setFilter("type", tpcoreEditor.default_tab, !0), $ele.on("preview:loaded", onEditorLoaded.bind(this))
        }, 
        this.getTabs = function() {
            var e = this.getFilter("type");
            return tabs = JSON.parse(tpcoreEditor.tab_style)
        ...
        this.requestLibraryData = function(e) {
            ...
            e.forceSync && (t.data.sync = !0), elementorCommon.ajax.addRequest("get_tpcore_library_data", t)
        }, 
        this.requestTemplateData = function(e, t) {
            ...
            t && jQuery.extend(!0, i, t), elementorCommon.ajax.addRequest("get_tpcore_template_data", i)
        }, 
...
}(jQuery, window.elementor, window.tpcore || {});

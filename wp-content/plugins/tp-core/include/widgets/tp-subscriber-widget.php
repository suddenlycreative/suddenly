<?php
	...
	class TP_Subscriber_Widget  extends WP_Widget{
		...
		public function __construct(){
			parent::__construct('tp_subscriber_widget',esc_html__('Harry Footer Subscriber','tocore'),array(
				'description' => esc_html__('Harry Subscriber Widget','tocore'),
			));
		}
		...
		?>
			...
			<div class="footer__subscribe">
				...
				<h3 class="footer__subscribe-title"><?php echo apply_filters( 'widget_title', $instance['title'] ); ?></h3>
				<?php endif; ?>

<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'tp_subscriber3_widget');
	function tp_subscriber3_widget() {
		register_widget('tp_subscriber3_widget');
	}
	
	
	class TP_Subscriber3_Widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('tp_subscriber3_widget',esc_html__('Harry Footer Subscriber 3','tocore'),array(
				'description' => esc_html__('Harry Subscriber Widget 3','tocore'),
			));
		}
		...
		?>
							...
							<div class="footer__subscribe-8">
								...
								<div class="footer__social mt-25 tp-footer-social-orange">

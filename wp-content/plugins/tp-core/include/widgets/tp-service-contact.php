<?php
	 ...
	 * @extends 	WP_Widget
	 */
	add_action('widgets_init', 'tp_service_sidebar_widget');
	function tp_service_sidebar_widget() {
		register_widget('tp_service_sidebar_widget');
	}
	
	
	class tp_service_sidebar_widget  extends WP_Widget{
		
		public function __construct(){
			parent::__construct('tp_service_sidebar_widget',esc_html__('Harry Service Sidebar Contact','tocore'),array(

...
class TpFooterPost 
{
	...
	public function register_custom_post_type() {
		...
		$labels = array(
			'name'                  => esc_html_x( 'Footers', 'Post Type General Name', 'tpcore' ),
			'singular_name'         => esc_html_x( 'Footer', 'Post Type Singular Name', 'tpcore' ),
			'menu_name'             => esc_html__( 'Footer', 'tpcore' ),
			'name_admin_bar'        => esc_html__( 'Footer', 'tpcore' ),
			...
			'add_new_item'          => esc_html__( 'Add New Footer', 'tpcore' ),
		...
		$args   = array(
			'label'                 => esc_html__( 'Footer', 'tpcore' ),
			'labels'                => $labels,
	...
	public function create_cat() {
		$labels = array(
			'name'                       => esc_html_x( 'Footer Categories', 'Taxonomy General Name', 'tpcore' ),
			'singular_name'              => esc_html_x( 'Footer Categories', 'Taxonomy Singular Name', 'tpcore' ),
			'menu_name'                  => esc_html__( 'Footer Categories', 'tpcore' ),
			'all_items'                  => esc_html__( 'All Footer Category', 'tpcore' ),
			'parent_item'                => esc_html__( 'Parent Item', 'tpcore' ),
			'parent_item_colon'          => esc_html__( 'Parent Item:', 'tpcore' ),
			'new_item_name'              => esc_html__( 'New Footer Category Name', 'tpcore' ),
			'add_new_item'               => esc_html__( 'Add New Footer Category', 'tpcore' ),
			'edit_item'                  => esc_html__( 'Edit Footer Category', 'tpcore' ),
			'update_item'                => esc_html__( 'Update Footer Category', 'tpcore' ),
			'view_item'                  => esc_html__( 'View Footer Category', 'tpcore' ),
			...
			'popular_items'              => esc_html__( 'Popular Footer Category', 'tpcore' ),
			'search_items'               => esc_html__( 'Search Footer Category', 'tpcore' ),
			'not_found'                  => esc_html__( 'Not Found', 'tpcore' ),
			'no_terms'                   => esc_html__( 'No Footer Category', 'tpcore' ),
			'items_list'                 => esc_html__( 'Footer Category list', 'tpcore' ),
			'items_list_navigation'      => esc_html__( 'Footer Category list navigation', 'tpcore' ),
		);

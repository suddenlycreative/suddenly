...
class TpServicesPost 
{
	...
	public function services_template_include( $template ) {
		if ( is_singular( 'tp-services' ) ) {
			return $this->get_template( 'single-tp-services.php');
		}
		return $template;
	}
	...
	public function register_custom_post_type() {
		$technix_services_slug = get_theme_mod( 'technix_services_slug', __( 'services', 'tpcore' ) );
		$labels = array(
			'name'                  => esc_html_x( 'Services', 'Post Type General Name', 'tpcore' ),
			'singular_name'         => esc_html_x( 'Service', 'Post Type Singular Name', 'tpcore' ),
			'menu_name'             => esc_html__( 'Services', 'tpcore' ),
			'name_admin_bar'        => esc_html__( 'Services', 'tpcore' ),
		...
		$args   = array(
			...
			'rewrite' => array(
				'slug' => $technix_services_slug,
				'with_front' => false
			),
		);

		register_post_type( 'tp-services', $args );
	}
	...
	public function create_cat() {
		...
		register_taxonomy('services-cat','tp-services', $args );
	}

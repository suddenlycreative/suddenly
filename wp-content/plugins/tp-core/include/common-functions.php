...
trait TPCoreElementFunctions
{
    ...
    protected function tp_icon_style($control_id = null, $control_name = 'Icon/Image Style', $selector = '.single-service .icon'){
        ...
        $this->add_control(
            'tp_' . $control_id . 'area_background',
            [
    ...
    */
    ...
    protected function tp_link_controls_style($control_id = null, $control_name = null, $control_selector = null)
    {
        ...
        $this->add_control(
            'tp_' . $control_id . '_btn_normal_border_style',
            [
        ...
        $this->add_responsive_control(
            'tp_' . $control_id . '_btn_normal_border_width',
            [
        ...
        $this->add_control(
            'tp_' . $control_id . '_btn_hover_border_style',
            [
                'label' => esc_html__('Border Style', 'tp-core'),
                'type' => Controls_Manager::SELECT,
                'options' => [
        ...
        $this->add_responsive_control(
            'tp_' . $control_id . '_btn_hover_border_width',
            [
                'label' => esc_html__('Border Width', 'tp-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
    ...
    */
    protected function tp_section_title_render_controls($control_id = null, $section_name = 'Section Title',  $sub_title = 'Sub Title', $default_title = 'Your Section Title', $default_description = 'There are many variations of passages of Lorem Ipsum available, <br /> but the majority have suffered alteration.', $control_condition = 'layout-1', $default_title_tag = 'h2', $default_align = '',  $enable_section_title_show_hide = true, $default_section_title_enable = 'yes')
    {
        $this->start_controls_section(
    ...
    */
    ...
    protected function tp_section_title_render($control_id = null, $title_args = 'section__title' , $settings=null)
    {
    ...
    protected function tp_link_controls_render($control_id = null, $control_name = 'tp-btn' , $settings=null)
    {

        if ('2' == $settings['tp_' . $control_id .'_link_type']) {
            $this->add_render_attribute('tp-button-arg', 'href', get_permalink($settings['tp_' . $control_id .'_page_link']));
            $this->add_render_attribute('tp-button-arg', 'target', '_self');
            $this->add_render_attribute('tp-button-arg', 'rel', 'nofollow');
            $this->add_render_attribute('tp-button-arg', 'class', ''.$control_name.' tp-el-btn');
        } else {
            if ( ! empty( $settings['tp_' . $control_id .'_link']['url'] ) ) {
                $this->add_link_attributes( 'tp-button-arg', $settings['tp_' . $control_id .'_link'] );
                $this->add_render_attribute('tp-button-arg', 'class', ''.$control_name.' tp-el-btn');
            }
        }
    ...
    */
    ...
    protected function tp_columns($control_id = 'columns_options', $control_condition = 'layout-1', $control_name = 'Select Columns', $default_for_lg = '4', $default_for_md = '6', $default_for_sm = '6', $default_for_all = '12'){
        $this->start_controls_section(
    ...
    */
    ...
    protected function tp_query_controls($control_id = null, $control_name = null, $default_title_num = 6, $default_content_limit = '10', $post_type = 'post', $taxonomy = 'category', $posts_per_page = '6', $offset = '0', $orderby = 'date', $order = 'desc')
    {
    ...
    protected function tp_post_layout_2($control_id = null, $control_name = null){
        $this->start_controls_section(
            'tp_'. $control_id .'_',
            [
                'label' => sprintf(esc_html__('%s - Layout', 'tpcore'), $control_name),
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'layout-1' => esc_html__('Blog Full Slider', 'tpcore'),
                    'layout-2' => esc_html__('Blog Grid', 'tpcore'),
                    'layout-3' => esc_html__('Blog List', 'tpcore'),
                    'layout-4' => esc_html__('Blog Masonary', 'tpcore'),
                ],
                'default' => 'layout-1',
            ]
        );
        ...
        $this->add_control(
         'enable_sidebar',
            [
                'label'        => esc_html__( 'Enable Sidebar ?', 'tpcore' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'tpcore' ),
                'label_off'    => esc_html__( 'Hide', 'tpcore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
         'enable_border_style_sidebar',
            [
                'label'        => esc_html__( 'Enable Border Style For Sidebar', 'tpcore' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'tpcore' ),
                'label_off'    => esc_html__( 'Hide', 'tpcore' ),
                'return_value' => 'yes',
        ...
        $this->add_control(
         'enable_border_style_item',
            [
                'label'        => esc_html__( 'Enable Border Style For Item', 'tpcore' ),
                'type'         => \Elementor\Controls_Manager::SWITCHER,
                'label_on'     => esc_html__( 'Show', 'tpcore' ),
                'label_off'    => esc_html__( 'Hide', 'tpcore' ),
                'return_value' => 'yes',

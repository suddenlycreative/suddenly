<?php 
   ...
   */
   ...
   // social links 
   $facebook = get_theme_mod( 'header_facebook_link', __( 'https://yoururl.com/', 'technix' ) );
   $twitter = get_theme_mod( 'header_twitter_link', __( 'https://yoururl.com/', 'technix' ) );
   $linkedin = get_theme_mod( 'header_linkedin_link', __( 'https://yoururl.com/', 'technix' ) );
   $instagram = get_theme_mod( 'header_instagram_link', __( 'https://yoururl.com/', 'technix' ) );
   $youtube = get_theme_mod( 'header_youtube_link', __( 'https://yoururl.com/', 'technix' ) );
   $vimeo = get_theme_mod( 'header_vimeo_link', __( 'https://yoururl.com/', 'technix' ) );
